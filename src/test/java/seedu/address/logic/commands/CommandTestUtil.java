...
public class CommandTestUtil {
    ...
    public static final Integer VALID_TAG_1 = 1;
    public static final Integer VALID_TAG_2 = 2;
    public static final String VALID_NOTE_AMY = "Amy Amy Amy";
    public static final String VALID_NOTE_BOB = "Full name is bobby";
    ...
    public static final String TAG_DESC_FRIEND = " " + PREFIX_TAG + VALID_TAG_2;
    public static final String TAG_DESC_HUSBAND = " " + PREFIX_TAG + VALID_TAG_1;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_2).withNote(VALID_NOTE_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_1, VALID_TAG_2).withNote(VALID_NOTE_BOB).build();
    }
